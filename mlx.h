...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/04 04:20:14 by Charlie Roo       #+#    #+#             */
/*   Updated: 2023/09/04 04:37:56 by dyamen           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** EN msg - EN msg - EN msg
**
** The MinilibX uses 2 other libraries that you must add at
**      compilation :
**   -lmlx -lXext -lX11
**
** The Minilibx allows XPM images loading.
** Note that this implementation is incomplete.
** Please report any problems while loading thoes kind of images.
*/
